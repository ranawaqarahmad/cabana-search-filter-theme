  ...
  customElements.define(
    ...
    class QuickAddModal extends ModalDialog {
      ...
      hide(preventFocus = false) {
        ...
        const cartNotification = document.querySelector('.js-atc-success');
      ...
      show(opener) {
        ...
        var splitPrductUrl = productUrl.split('?');

        fetch(splitPrductUrl[0]+'/quick-view')
          ...
          .finally(() => {
            ...
            const checkMarquee = this.querySelectorAll('.marquee3k');
            const checkMarqueeElement = this.querySelector('.marquee-scrolling__option');
